...
static void _replace_kernel32__CreateProcessA_99(HINSTANCE hInstance) {
	_ptr_kernel32__CreateProcessA_99 _function;
	if(hInstance!=GetModuleHandle("kernel32.dll")) {
		_function=(_ptr_kernel32__CreateProcessA_99)XYO::Win::Inject::Hook::replaceFunction(hInstance,(PROC)_new_kernel32__CreateProcessA_99,"kernel32.dll","CreateProcessA",99);
		if(_function!=NULL) {
			_original_kernel32__CreateProcessA_99=_function;
		} else {
			_function=(_ptr_kernel32__CreateProcessA_99)XYO::Win::Inject::Hook::replaceFunction(hInstance,(PROC)_new_kernel32__CreateProcessA_99,"kernel32","CreateProcessA",99);
			if(_function!=NULL) {
				_original_kernel32__CreateProcessA_99=_function;
			};
		};
...
static void _replace_kernel32__CreateProcessW_103(HINSTANCE hInstance) {
	_ptr_kernel32__CreateProcessW_103 _function;
	if(hInstance!=GetModuleHandle("kernel32.dll")) {
		_function=(_ptr_kernel32__CreateProcessW_103)XYO::Win::Inject::Hook::replaceFunction(hInstance,(PROC)_new_kernel32__CreateProcessW_103,"kernel32.dll","CreateProcessW",103);
		if(_function!=NULL) {
			_original_kernel32__CreateProcessW_103=_function;
		} else {
			_function=(_ptr_kernel32__CreateProcessW_103)XYO::Win::Inject::Hook::replaceFunction(hInstance,(PROC)_new_kernel32__CreateProcessW_103,"kernel32","CreateProcessW",103);
			if(_function!=NULL) {
				_original_kernel32__CreateProcessW_103=_function;
			};
		};
...
static void _replace_kernel32__LoadLibraryA_578(HINSTANCE hInstance) {
	_ptr_kernel32__LoadLibraryA_578 _function;
	if(hInstance!=GetModuleHandle("kernel32.dll")) {
		_function=(_ptr_kernel32__LoadLibraryA_578)XYO::Win::Inject::Hook::replaceFunction(hInstance,(PROC)_new_kernel32__LoadLibraryA_578,"kernel32.dll","LoadLibraryA",578);
		if(_function!=NULL) {
			_original_kernel32__LoadLibraryA_578=_function;
		} else {
			_function=(_ptr_kernel32__LoadLibraryA_578)XYO::Win::Inject::Hook::replaceFunction(hInstance,(PROC)_new_kernel32__LoadLibraryA_578,"kernel32","LoadLibraryA",578);
			if(_function!=NULL) {
				_original_kernel32__LoadLibraryA_578=_function;
			};
		};
...
static void _replace_kernel32__LoadLibraryExA_579(HINSTANCE hInstance) {
	_ptr_kernel32__LoadLibraryExA_579 _function;
	if(hInstance!=GetModuleHandle("kernel32.dll")) {
		_function=(_ptr_kernel32__LoadLibraryExA_579)XYO::Win::Inject::Hook::replaceFunction(hInstance,(PROC)_new_kernel32__LoadLibraryExA_579,"kernel32.dll","LoadLibraryExA",579);
		if(_function!=NULL) {
			_original_kernel32__LoadLibraryExA_579=_function;
		} else {
			_function=(_ptr_kernel32__LoadLibraryExA_579)XYO::Win::Inject::Hook::replaceFunction(hInstance,(PROC)_new_kernel32__LoadLibraryExA_579,"kernel32","LoadLibraryExA",579);
			if(_function!=NULL) {
				_original_kernel32__LoadLibraryExA_579=_function;
			};
		};
...
static void _replace_kernel32__LoadLibraryExW_580(HINSTANCE hInstance) {
	_ptr_kernel32__LoadLibraryExW_580 _function;
	if(hInstance!=GetModuleHandle("kernel32.dll")) {
		_function=(_ptr_kernel32__LoadLibraryExW_580)XYO::Win::Inject::Hook::replaceFunction(hInstance,(PROC)_new_kernel32__LoadLibraryExW_580,"kernel32.dll","LoadLibraryExW",580);
		if(_function!=NULL) {
			_original_kernel32__LoadLibraryExW_580=_function;
		} else {
			_function=(_ptr_kernel32__LoadLibraryExW_580)XYO::Win::Inject::Hook::replaceFunction(hInstance,(PROC)_new_kernel32__LoadLibraryExW_580,"kernel32","LoadLibraryExW",580);
			if(_function!=NULL) {
				_original_kernel32__LoadLibraryExW_580=_function;
			};
		};
...
static void _replace_kernel32__LoadLibraryW_581(HINSTANCE hInstance) {
	_ptr_kernel32__LoadLibraryW_581 _function;
	if(hInstance!=GetModuleHandle("kernel32.dll")) {
		_function=(_ptr_kernel32__LoadLibraryW_581)XYO::Win::Inject::Hook::replaceFunction(hInstance,(PROC)_new_kernel32__LoadLibraryW_581,"kernel32.dll","LoadLibraryW",581);
		if(_function!=NULL) {
			_original_kernel32__LoadLibraryW_581=_function;
		} else {
			_function=(_ptr_kernel32__LoadLibraryW_581)XYO::Win::Inject::Hook::replaceFunction(hInstance,(PROC)_new_kernel32__LoadLibraryW_581,"kernel32","LoadLibraryW",581);
			if(_function!=NULL) {
				_original_kernel32__LoadLibraryW_581=_function;
			};
		};
...
static void _replace_kernel32__LoadModule_582(HINSTANCE hInstance) {
	_ptr_kernel32__LoadModule_582 _function;
	if(hInstance!=GetModuleHandle("kernel32.dll")) {
		_function=(_ptr_kernel32__LoadModule_582)XYO::Win::Inject::Hook::replaceFunction(hInstance,(PROC)_new_kernel32__LoadModule_582,"kernel32.dll","LoadModule",582);
		if(_function!=NULL) {
			_original_kernel32__LoadModule_582=_function;
		} else {
			_function=(_ptr_kernel32__LoadModule_582)XYO::Win::Inject::Hook::replaceFunction(hInstance,(PROC)_new_kernel32__LoadModule_582,"kernel32","LoadModule",582);
			if(_function!=NULL) {
				_original_kernel32__LoadModule_582=_function;
			};
		};
...
static void _replace_kernel32__GetProcAddress_408(HINSTANCE hInstance) {
	_ptr_kernel32__GetProcAddress_408 _function;
	if(hInstance!=GetModuleHandle("kernel32.dll")) {
		_function=(_ptr_kernel32__GetProcAddress_408)XYO::Win::Inject::Hook::replaceFunction(hInstance,(PROC)_new_kernel32__GetProcAddress_408,"kernel32.dll","GetProcAddress",408);
		if(_function!=NULL) {
			_original_kernel32__GetProcAddress_408=_function;
		} else {
			_function=(_ptr_kernel32__GetProcAddress_408)XYO::Win::Inject::Hook::replaceFunction(hInstance,(PROC)_new_kernel32__GetProcAddress_408,"kernel32","GetProcAddress",408);
			if(_function!=NULL) {
				_original_kernel32__GetProcAddress_408=_function;
			};
		};
